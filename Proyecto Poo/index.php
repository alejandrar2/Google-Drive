...
<body style="background-color: white;" >
	...
	<header class="fondo1">
		...
		<div class="col-xs-12">
			<div class="centro">
				<br><a class="btn btn-primary" href="googledrive.php" >Ir a Google Drive</a>
			</div>
		</div>	
	</header>
	<div class="container">
	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col columna"><a class="btn btn-primary" href="googledrive.php" >Ir a Google Drive</a></div>
			</div>
			<div class="row">
