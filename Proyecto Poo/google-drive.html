...
<body style="background-color: white;" >
	...
	<nav style="background-color: white;" class="navbar navbar-expand-lg navbar-light bg-light">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto"><li class="nav-item active"></li></ul>
					...
					<li class="nav-item"><a class="nav-link-azul" href="googledrive.html" style="color:white">Ir A Google Drive</a></li>
				</ul>
			</div>
		</div>
	</nav>
	<header class="fondo1">
		...
		<div class="col-xs-12">
			<div class="centro">
				<br><a class="btn btn-primary" href="googledrive.html" >Ir a Google Drive</a>
			</div>
		</div>	
	</header>
	<div class="container">
	...
	<div class="row">
		...
		<div class="container">
			...
			<div class="row">
				<div class="col columna"><a class="btn btn-primary" href="googledrive.html" >Ir a Google Drive</a></div>
			</div>
			<div class="row">
		...
		<footer style="background-color:#F5F5F5;">
			...
			<div class="container" style="style="background-color:#F5F5F5;margin: auto; padding: 0px; ">
				<div class="row " >
